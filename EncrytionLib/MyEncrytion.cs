...
{
    public static class MyEncrytion
    {
        ...
        public static bool HasLicense()
        {
            ...
            if (key != null)
            {
                ...
                if (value != null)
                {
                    ...
                    if (licensekey == NetworkInterface.GetAllNetworkInterfaces()[0].Id)
                    {
                        return true;
                    }
        ...
        public static void WriteLicense()
        {
            ...
            if (key != null)
            {
                ...
                byte[] encrypt = EncryptString(NetworkInterface.GetAllNetworkInterfaces()[0].Id);
